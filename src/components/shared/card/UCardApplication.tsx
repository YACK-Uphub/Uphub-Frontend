      ...
      <div className="flex items-center gap-3">
        <div className="relative mb-2 h-16 w-16 overflow-hidden rounded-full bg-custom-gray">
          <Image
            src={
              avatarUrl ||
              "https://firebasestorage.googleapis.com/v0/b/mechat-926e4.appspot.com/o/uphub%2Fimages%2Fplaceholders%2Fdefault-user.jpg?alt=media&token=add003e2-145f-4e50-9642-ad4a3dd92d15"
            }
            alt={`${name} Logo`}
            fill={true}
            objectFit={"cover"}
