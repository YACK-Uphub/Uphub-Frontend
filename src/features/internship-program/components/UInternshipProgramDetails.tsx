          ...
          <div className="flex w-full flex-col gap-6 lg:w-1/3">
              ...
              {[
                ...
                },
                {
                  ...
                  <div key={i} className="flex items-center space-x-3">
                    <div
                        className={`flex h-10 w-10 items-center justify-center rounded-lg ${item.bg}`}>{item.icon}</div>
                    <div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                    className="flex items-center gap-2 rounded px-4 py-2 text-white bg-custom-blue-2 hover:bg-custom-blue-3">
