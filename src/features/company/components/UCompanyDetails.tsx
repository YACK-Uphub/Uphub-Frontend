          ...
          <div className="flex w-full flex-col gap-6 lg:w-1/3">
            ...
            <div className="mx-auto w-full max-w-md rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="flex items-start gap-3 border-t border-gray-100 pt-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{company.websiteUrl}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 border-t border-gray-100 pt-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{company.phoneNumber}</p>
                </div>
              </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-sm">
              ...
              <div className="flex flex-wrap gap-4">
                <button
                    className="flex items-center rounded px-4 py-2 text-white transition-colors space-x-2 bg-custom-blue-2 hover:bg-custom-blue-3">
                  <Facebook className="h-4 w-4"/>
                  <span>Facebook</span>
                </button>
                <button
                    className="flex items-center rounded bg-sky-500 px-4 py-2 text-white transition-colors space-x-2 hover:bg-sky-600">
