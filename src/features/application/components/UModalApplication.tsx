      ...
      <div className="mx-auto flex flex-col gap-8 md:flex-row">
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 border-b pb-6 border-custom-gray/30">
            ...
            <p className="whitespace-pre-line text-custom-gray/70">{data.introduction || "Không có thông tin giới" +
                " thiệu"}</p>
          </div>
          ...
          <div className="mt-6 pb-6">
            ...
            <p className="whitespace-pre-line text-custom-gray/70">{data.coverLetter || "Không" +
                " có thư" +
                " xin việc"}</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-80 space-y-4">
          ...
          <div className="rounded-lg border p-4 border-custom-gray/20 bg-custom-gray/5">
            ...
            <div className="text-sm text-gray-600 space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className={"flex items-center gap-3"}>
                  <strong className="text-gray-700">Địa
                    điểm: </strong> {data.city || "Không xác định"}
                </div>
              </div>
              <div className="flex items-start gap-3">
                <CurrencyDollarIcon className="h-4 w-4 flex-shrink-0 mt-0.5"/>
                <div className={"flex items-center gap-3"}>
                  <strong className="text-gray-700">Mức
                    lương: </strong> {data.salaryRange || "Thương lượng"}
                </div>
              </div>
              <div className="flex items-start gap-3">
                <ClockIcon className="h-4 w-4 flex-shrink-0 mt-0.5"/>
                <div className={"flex items-center gap-3"}>
                  <strong className="text-gray-700">Loại
                    hình: </strong> {data.jobType || "Toàn thời gian"}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-lg border p-4 border-custom-gray/20 bg-custom-gray/5">
            ...
            <div
              ...
              <span
                  className={`p-2 rounded-md shadow-sm ${getStyleApplicationStatus(data.status).text} ${getStyleApplicationStatus(data.status).bg}`}>{data.status || "Đang xử lý"}</span>
            </div>
          </div>
          <div className="flex items-center gap-3">
            ...
            <div className={"flex items-center gap-3"}>
                  <span
                      className="text-custom-gray">Cập nhật:</span> {new Date().toLocaleDateString()}
            </div>
          </div>
        </div>
      </div>
